...
- Added a horizontal Command-Tab window switcher.
- Added per-display window sidebars.
- Added Windows-style Dock click behavior.
- Renamed the user-facing application to Taab.

The AltTab upstream changelog is retained below for source-history context.
