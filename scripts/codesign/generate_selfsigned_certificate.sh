...
# Keep the local development identity stable for ten years. TCC permissions are
# tied to this signing identity, so a short-lived certificate would force the
# user to grant Accessibility and Screen Recording again after it expires.
