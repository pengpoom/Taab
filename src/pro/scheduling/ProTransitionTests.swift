...
final class ProTransitionTests: XCTestCase {
    ...
    /// Engaged user (e.g. `.titles` configured pre-trial). On Day 15, opens Glide → free-pass + [C] queued.
    ...
    /// Non-engaged user (e.g. only `.auto` size, or no Pro feature at all). On Day 15, opens Glide
