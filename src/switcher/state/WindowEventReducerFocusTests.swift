...
final class WindowEventReducerFocusTests: XCTestCase {
    ...
    /// The QA I-11 capture (2026-07-31). Glide focuses a MINIMIZED window, so it deminiaturizes first —
    /// and unlike every other Glide focus, that stirs the app's other windows. macOS answered with a focus
    /// 808 for the SIBLING 38ms into the activation; with an Glide activation's empty snapshot that was not
    ...
    /// The two live behaviours differ only by whether Glide had to deminiaturize.
