...
final class TestScenarioSimulatorTests: XCTestCase {
    ...
    // MARK: - cold start (Glide launched into a desktop that already existed)
    ...
    /// and it is not the condition Glide actually launches in. These seed a world with `preexisting` and
