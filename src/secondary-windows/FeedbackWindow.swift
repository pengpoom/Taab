...
class FeedbackWindow: NSWindow {
    ...
    private func showKindPicker() {
        ...
        let subtitle = NSTextField(labelWithString: NSLocalizedString("Help improve Taab", comment: ""))
    ...
    private func showUpdateAvailableAlert(item: SUAppcastItem) {
        ...
        alert.messageText = NSLocalizedString("A new version of Taab is available", comment: "")
