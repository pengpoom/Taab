...
/// Pure decision layer for "can Glide actually persist its preferences to disk?".
///
/// Glide stores prefs via `UserDefaults`/`CFPreferences`, which `cfprefsd` brokers. cfprefsd keeps values
