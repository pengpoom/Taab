...
class UpgradeTab {
    ...
    private static func makeHeaderStrip() -> NSStackView {
        ...
        let titleText = NSLocalizedString("Taab Pro", comment: "")
    ...
    private static func makeProManageTable() -> TableGroupView {
        ...
        let deactivateHint = TableGroupView.makeText(NSLocalizedString("License will remain valid and usable to activate Taab on any machine", comment: ""))
